      ...
      <div className=" text-center space-y-20  max-w-screen-xl mx-auto  py-10">
        ...
        <div className="flex justify-evenly flex-col gap-8 md:flex-row">
          <div className="space-y-3">
            <CreditCard className="mx-auto rounded-full bg-slate-400 hover:bg-gray-200 cursor-pointer p-3 " />
            <h1 className="font-semibold text-xl">Full Support</h1>
            <p>Lorem ipsum dolor sit amet.</p>
          </div>
          <div className="space-y-3">
            <Trolly className="mx-auto rounded-full bg-slate-400 hover:bg-gray-200 cursor-pointer p-3 " />
            <h1 className="font-semibold text-xl">Best Store</h1>
            <p>Lorem ipsum dolor sit amet.</p>
          </div>
          <div className="space-y-3">
            <Lock className="mx-auto rounded-full bg-slate-400 hover:bg-gray-200 cursor-pointer p-3 " />
        ...
        <div className="flex  justify-evenly flex-col gap-4 md:flex-row ">
          <div>
            <img
              src={AboutDesign2}
              alt=""
              className="aspect-[3/4] w-[340px] mx-auto"
            />
            <div className="flex  flex-col text-center space-y-3">
              <h1 className="text-5xl font-serif pt-5">3100+</h1>
              <p className="text-lg font-semibold">
                More than 3700 Social Friends
              </p>
            </div>
          </div>
          <div>
            ...
            />
            <div className="flex  flex-col text-center space-y-3">
              <h1 className="text-5xl font-serif pt-5">5100k</h1>
              <p className="text-lg font-semibold">
          ...
          <div>
            ...
            />
            <div className="flex  flex-col text-center space-y-3">
              <h1 className="text-5xl font-serif pt-5">100%</h1>
              <p className="text-lg font-semibold">
                Only used quality materials
              </p>
            </div>
          </div>
        </div>
